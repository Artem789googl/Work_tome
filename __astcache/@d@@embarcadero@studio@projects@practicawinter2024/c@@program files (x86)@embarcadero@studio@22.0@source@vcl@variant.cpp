...
{
#if defined(_WIN32)
  ::VariantInit(reinterpret_cast<VARIANTARG*>(&vd));
#else  
...
{
#if defined(VARIANT_AUTOMATION_SUPPORT)
  Variant Variant::CreateObject(const System::String& ProgID)
  {
    return Variant(System::Win::Comobj::CreateOleObject(const_cast<System::String&>(ProgID)));
  }

  Variant Variant::GetActiveObject(const System::String& ProgID)
  {
  ...
  Variant::Variant(const TVarData& rhs)
  {
  ...
  Variant::Variant(const TVariant& rhs)
  {
  ...
  inline void Variant::SetType(uint16_t vt, bool init)
  {
    if (init)
      InitVariant(VARIANT_AS_TVARDATA(*this));
    else
  ...
  inline void Variant::SetRefType(uint16_t vt, void *p, bool init)
  {
  ...
  Variant::Variant(const bool src)
  {
    SetType(varBoolean, true);
    VBoolean = src ? VARIANT_TRUE : VARIANT_FALSE;
  }

  Variant::Variant(const char src)
  {
    SetType(varShortInt, true);
    VShortInt = src;
  }

  Variant::Variant(const signed char src)
  {
    SetType(varShortInt, true);
    VShortInt = src;
  }

  Variant::Variant(const unsigned char src)
  {
    SetType(varByte, true);
    VByte = src;
  }

  Variant::Variant(const short src)
  {
    SetType(varSmallint, true);
    VSmallint = src;
  }

  Variant::Variant(const unsigned short src)
  {
    SetType(varWord, true);
    VWord = src;
  }

  Variant::Variant(const int src)
  {
    SetType(varInteger, true);
    VInteger = src;
  }

  Variant::Variant(const unsigned int src)
  {
    SetType(varLongWord, true);
    VLongWord = src;
  }

  Variant::Variant(const long src)
  {
    SetType(Variant_varLong, true);
    Variant_VLong = src;
  }

  Variant::Variant(const unsigned long src)
  {
    SetType(Variant_varULong, true);
    Variant_VLong = src;
  }

  Variant::Variant(const float src)
  {
    SetType(varSingle, true);
    VSingle = src;
  }

  Variant::Variant(const double src)
  {
    SetType(varDouble, true);
    VDouble = src;
  }

  Variant::Variant(const long double src)
  {
    SetType(varDouble, true);
    VDouble = src;
  }

  Variant::Variant(const __int64 src)
  {
    SetType(varInt64, true);
    VInt64 = src;
  }
  
  Variant::Variant(const unsigned __int64 src)
  {
  ...
  Variant::Variant(const CURRENCY& src)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
    SET_VTYPE_AND_VAR(CY, src);
  }

  Variant::Variant(const DECIMAL& src)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
  ...
  Variant::Variant(const SAFEARRAY& src)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
  ...
  //       be safe.
  //
  Variant::Variant(const AnsiString& src)
  {
  ...
  Variant::Variant(const TDateTime& src)
  {
  ...
  Variant::Variant(const VariantError& src)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
...
#if !defined(_DELPHI_NEXTGEN)
  Variant::Variant(const WideString& src)
  {
  ...
  Variant::Variant(const UnicodeString& src)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
...
#if defined(VARIANT_NATIVE_SUPPORT)
  Variant::Variant(wchar_t* src, bool makeCopy)
  {
    SetType(varOleStr, true);
#if !defined(_DELPHI_NEXTGEN) 
  ...
  Variant::Variant(signed char* src)
  {
    SetRefType(varShortInt, src, true);
  }

  Variant::Variant(unsigned char* src)
  {
    SetRefType(varByte, src, true);
  }

  Variant::Variant(short* src)
  {
    SetRefType(varSmallint, src, true);
  }

  Variant::Variant(unsigned short* src)
  {
    SetRefType(varWord, src, true);
  }

  Variant::Variant(int* src)
  {
    SetRefType(varInteger, src, true);
  }

  Variant::Variant(unsigned int* src)
  {
    SetRefType(varLongWord, src, true);
  }

  Variant::Variant(long* src)
  {
    SetRefType(Variant_varLong, src, true);
  }

  Variant::Variant(unsigned long* src)
  {
    SetRefType(Variant_varULong, src, true);
  }

  Variant::Variant(float* src)
  {
    SetRefType(varSingle, src, true);
  }

  Variant::Variant(double* src)
  {
    SetRefType(varDouble, src, true);
  }

  Variant::Variant(__int64* src)
  {
    SetRefType(varInt64, src, true);
  }

  Variant::Variant(unsigned __int64* src)
  {
    SetRefType(varUInt64, src, true);
  }

#if defined(VARIANT_NATIVE_SUPPORT)
  Variant::Variant(CURRENCY* src)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
    SET_VTYPE_AND_VARREF(CY, src);
  }

  Variant::Variant(DECIMAL* src)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
  ...
  Variant::Variant(wchar_t** src)        // VT_BSTR|VT_BYREF
  {
  ...
  Variant::Variant(const int* bounds, const int boundsSize, Word varType)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
  ...
  Variant::Variant(const Variant* values, const int valuesSize)
  {
    InitVariant(VARIANT_AS_TVARDATA(*this));
    *this = Variants::VarArrayOf(values, valuesSize);
  }

  Variant::Variant(const System::DelphiInterface<IDispatch>& src)
  {
    SetType(varDispatch, true);
    if (src)
      src->AddRef();
  ...
  Variant& Variant::operator =(const signed char rhs)
  {
    SetType(varShortInt, false);
    VShortInt = rhs;
    return *this;
  ...
  Variant& Variant::operator =(const unsigned char rhs)
  {
  ...
  Variant& Variant::operator =(const short rhs)
  {
  ...
  Variant& Variant::operator =(const unsigned short rhs)
  {
  ...
  Variant& Variant::operator =(const unsigned int rhs)
  {
  ...
  Variant& Variant::operator =(const unsigned long rhs)
  {
  ...
  Variant& Variant::operator =(const __int64 rhs)
  {
  ...
  Variant& Variant::operator =(const unsigned __int64 rhs)
  {
...
#if defined(VARIANT_NATIVE_SUPPORT)
  Variant& Variant::operator =(const CURRENCY& rhs)
  {
    Clear();
  ...
  Variant& Variant::operator =(const DECIMAL& rhs)
  {
    Clear();
  ...
  Variant& Variant::operator =(const SAFEARRAY& rhs)
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
  ...
  Variant& Variant::operator =(SAFEARRAY* rhs)
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
...
#if defined(VARIANT_TVARIANT_SUPPORT)
  Variant& Variant::operator =(const TVariant& rhs)
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
  ...
  Variant& Variant::operator =(TVariant *rhs)
  {
...
#if defined(WIDECHAR_IS_WCHAR)
  Variant& Variant::Assign(wchar_t* rhs, bool makeCopy)
  {
#if !defined(_DELPHI_NEXTGEN)
  ...
  Variant& Variant::operator =(IUnknown* rhs)
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
  ...
  Variant& Variant::operator =(IDispatch* rhs)
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
  ...
  Variant& Variant::operator =(const AnsiString& rhs)
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
  ...
  Variant& Variant::operator =(const TDateTime& rhs)
  {
...
#if defined(VARIANT_ERROR_SUPPORT)
  Variant& Variant::operator =(const VariantError& rhs)
  {
    Clear();
...
#if !defined(_DELPHI_NEXTGEN)
  Variant& Variant::operator =(const WideString& rhs)
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
  ...
  Variant& Variant::operator =(const UnicodeString& src)
  {
    System::Internal::Varhlpr::VariantFromUnicodeString(*this, src);
    return *this;
  }

  Variant& Variant::operator =(const System::DelphiInterface<IDispatch>& rhs)
  {
  ...
  Variant& Variant::operator =(const char* rhs)            // Treated as pointer Asciiz string
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
  ...
  Variant& Variant::operator =(signed char* src)
  {
    SetRefType(varShortInt, src, false);
    return *this;
  }

  Variant& Variant::operator =(unsigned char* src)
  {
    SetRefType(varByte, src, false);
    return *this;
  }

  Variant& Variant::operator =(short* src)
  {
    SetRefType(varSmallint, src, false);
    return *this;
  }

  Variant& Variant::operator =(unsigned short* src)
  {
    SetRefType(varWord, src, false);
    return *this;
  }

  Variant& Variant::operator =(int* src)
  {
    SetRefType(varInteger, src, false);
    return *this;
  }

  Variant& Variant::operator =(unsigned int* src)
  {
    SetRefType(varLongWord, src, false);
    return *this;
  }

  Variant& Variant::operator =(long* src)
  {
    SetRefType(Variant_varLong, src, false);
    return *this;
  }

  Variant& Variant::operator =(unsigned long* src)
  {
    SetRefType(Variant_varULong, src, false);
    return *this;
  }

  Variant& Variant::operator =(float* src)
  {
    SetRefType(varSingle, src, false);
    return *this;
  }

  Variant& Variant::operator =(double* src)
  {
    SetRefType(varDouble, src, false);
    return *this;
  }

  Variant& Variant::operator =(__int64* src)
  {
    SetRefType(varInt64, src, false);
    return *this;
  }

  Variant& Variant::operator =(unsigned __int64* src)
  {
  ...
  Variant& Variant::operator =(CURRENCY* src)
  {
    Clear();
    SET_VTYPE_AND_VARREF(CY, src);
    return *this;
  ...
  Variant& Variant::operator =(DECIMAL* rhs)
  {
    Variant newVal(rhs);
    swap(newVal);
    return *this;
...
#if defined(WIDECHAR_IS_WCHAR)
  Variant& Variant::operator =(WideChar** src)
  {
  ...
  Variant& Variant::operator =(IUnknown** src)
  {
    SetRefType(varUnknown, src, false);
    return *this;
  }

  Variant& Variant::operator =(IDispatch** src)
  {
    SetRefType(varDispatch, src, false);
    return *this;
  }

  Variant& Variant::operator =(IInterface** src)
  {
    SetRefType(varUnknown, src, false);
    return *this;
  }
  ...
  Variant& Variant::operator =(TDateTime* src)
  {
  ...
  bool Variant::operator ==(const Variant& src) const
  {
...
#define VAR_SIMPLE_OP( op ) \
...
#if !defined(_DELPHI_NEXTGEN)
  Variant::operator AnsiString() const
  {
    Variant tmp;
  ...
  Variant::operator TDateTime() const
  {
    Variant tmp;
  ...
  Variant::operator UnicodeString() const
  {
    UnicodeString str;
  ...
  Variant::operator DECIMAL() const
  {
    Variant tmp;
  ...
  void Variant::CastError(uint16_t vt)
  {
...
#if !defined(_PLAT_IOS64) && !defined(_PLAT_LINUX64) // FIXME-_PLAT_IOS64
  ...
  Variant::operator unsigned __int64*()
  {
  ...
  void Variant::SetError(const HResult err)
  {
    SetType(varError, false);
    VError = err;
  }

  HResult Variant::GetError() const
  {
    Variant tmp;
  ...
  //
  Variant* Variant::GetBaseVariant()
  {
    Variant *pVar = this;
  ...
  Variant& Variant::ChangeType(int varType)
  {
    Variant tmp;
  ...
  Variant Variant::AsType(int varType) const
  {
    Variant tmp;
    System::Internal::Varhlpr::VariantCast(*this, tmp, varType);
    return tmp;
  ...
  Variant Variant::Sanitized() const
  {
#if defined(VARIANT_NATIVE_SUPPORT)
    Variant tmp;
 #if !defined(_DELPHI_NEXTGEN)
  ...
  Variant Variant::GetElement(const int i1) const
  {
    return System::Internal::Varhlpr::VariantGetElement(*this, i1);
  }

  Variant Variant::GetElement(const int i1, const int i2) const
  {
    return System::Internal::Varhlpr::VariantGetElement(*this, i1, i2);
  }

  Variant Variant::GetElement(const int i1, const int i2, const int i3) const
  {
    return System::Internal::Varhlpr::VariantGetElement(*this, i1, i2, i3);
  }

  Variant Variant::GetElement(const int i1, const int i2, const int i3, const int i4) const
  {
    return System::Internal::Varhlpr::VariantGetElement(*this, i1, i2, i3, i4);
  }

  Variant Variant::GetElement(const int i1, const int i2, const int i3, const int i4, const int i5) const
  {
    return System::Internal::Varhlpr::VariantGetElement(*this, i1, i2, i3, i4, i5);
  }

  void Variant::PutElement(const Variant& data, const int i1)
  {
    return System::Internal::Varhlpr::VariantPutElement(*this, data, i1);
  }

  void Variant::PutElement(const Variant& data, const int i1, const int i2)
  {
    return System::Internal::Varhlpr::VariantPutElement(*this, data, i1, i2);
  }

  void Variant::PutElement(const Variant& data, const int i1, const int i2, const int i3)
  {
    return System::Internal::Varhlpr::VariantPutElement(*this, data, i1, i2, i3);
  }

  void Variant::PutElement(const Variant& data, const int i1, const int i2, const int i3, const int i4)
  {
    return System::Internal::Varhlpr::VariantPutElement(*this, data, i1, i2, i3, i4);
  }

  void Variant::PutElement(const Variant& data, const int i1, const int i2, const int i3, const int i4, const int i5)
  {
  ...
  Variant Variant::Exec(AutoCmd& cmd, Integer) const
  {
    //Result
    Variant tmp;
    Variant* ptmp = 0;
...
// extern PACKAGE void VariantClear(System::Variant &V);
// extern PACKAGE void VariantCast(const System::Variant &src, System::Variant &dst, int vt);
// extern PACKAGE void VariantArrayRedim(System::Variant &V, int High);

  void VarClear(Variant& v)
  {
    System::Internal::Varhlpr::VariantClear(v);
  }

  void VarCast(Variant &dest, const Variant& source, int type)
  {
    System::Internal::Varhlpr::VariantCast(source, dest, type);
  }

  void VarArrayRedim(Variant& a, int high)
  {
  ...
  {
    str = src.operator UnicodeString();
  }
